	...
	quiz: [
		{
			...
			answer: ['Шарм-эль-шейх', 'Каир', 'a', 'an'],
			rightAnswer: 'Каир',
		},
		{
			question: 'Самая низкая температура зафиксированная а Египте?',
			answer: ['+7 градусов', '-3 градуса', '-8 градусов', '+18 градусов'],
			rightAnswer: '+18 градусов',
		},
	],
}; //island
